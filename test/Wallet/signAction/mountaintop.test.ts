import { Beef, BigNumber, Hash, P2PKH, PublicKey, Signature, Transaction, TransactionSignature, UnlockingScript, Utils } from "@bsv/sdk"
...
describe('mountaintop tests', () => {
    ...
    test('0 signature validity', async () => {
        ...
        const privKey = await setup.wallet.keyDeriver.derivePrivateKey(
            [1, 'mountaintops'],
            '1',
            'anyone'
        )
        ...
        const msg = [111,16,29,104,166,199,108,36,242,153,242,104,10,198,151,176,170,69,98,209,88,105,113,199,124,56,189,3,104,214,94,76]
...
const outpoints = ['30c83f8b84864fd4497414980faadf074192e7193602ef96ca18705876ce74b1.0', '797bd197f2328931231f2834c5dc8036fe9990981c368df27d3b55fa926863be.0', '08d47d844e81d751691f6b4a39ce378e9d0f70a3a0606c87995f0f28399552e2.0']
